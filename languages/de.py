...
'%(pf_name)s published %(date)s. ## %x': '%(pf_name)s veröffentlicht am %(date)s.',
'%(pf_name)s published %(date)s. ## %B %Y': '%(pf_name)s veröffentlicht im %(date)s.',
'%(pf_name)s published %(date)s. ## %Y': '%(pf_name)s veröffentlicht %(date)s.',
'%Y-%m-%d': '%Y-%m-%d',
